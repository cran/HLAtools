...
### Genomic Reference Alleles

The *IMGTGenomicReferences* data object identifies an IPD-IMGT/HLA reference allele and a GRCh38 reference allele (when available) for each of the 44 genes in the IPD-IMGT/HLA Database, along with each gene's Ensembl version, GRCh38 location and initiator methionine start position. GRCh38 reference alleles remain undefined for DRB6, DRB7, HLA-P and HLA-Y. A new *IMGTGenomicReferences* data object can be generated using the *buildGenomicReferences()* function, although *IMGTGenomicReferences* is not expected to change unless GRCh38 alleles are assigned for DRB6, DRB7, HLA-P or HLA-Y, or new genes are added to the IPD-IMGT/HLA Database. The source data for this object can be found online at <https://www.ebi.ac.uk/ipd/imgt/hla/about/help/genomics/>. 

```
IMGTGenomicReferences$GenomicReferences[1:3,]
   Gene     Ensemblversion      GRCh38 Location Start of ATG (Initiator Met) GRCh38 reference allele IPD-IMGT/HLA reference allele
1   HFE ENSG00000010704.18 CM000668.2 (forward)                 6:26,087,441           HFE*001:01:01                 HFE*001:01:01
2 HLA-F ENSG00000204642.14 CM000668.2 (forward)                 6:29,723,464           F*01:03:01:01                 F*01:01:01:01
3 HLA-V ENSG00000181126.13 CM000668.2 (forward)                 6:29,792,234           V*01:01:01:01                 V*01:01:01:01
```
